...
@section('content')
    ...
    <div class="row display_plans" style=" margin: 10px 0px 0px -15px;">
        ...
        <div class="col-md-8" style="padding: 5px;margin:0px ">
            ...
            <div class="row"style="margin-top: 30px;">
                ...
                <div style="margin: 5px;font-family: Times New Roman ;">
                    ...
                    <a href="/profile/edit" style="text-decoration:none"> <button style="margin:15px 0px 0px 75px" type="button" class="btn btn-outline-secondary"><i class="fas fa-edit"></i> Thay đổi thông tin</button></a>
        ...
        <div class="col-md-12 text-center">
            <a href="/plan/add" style="text-decoration:none"><button style="width: 40%;margin-top: 20px;" type="button" class="btn btn-outline-secondary">
