...
@section('content')
    ...
    <div class="row display_plans" style=" margin: 10px 0px 0px -15px;">
            ...
            <div class="row"style="margin-top: 30px;">
                <div style="margin: 5px;font-family: Times New Roman;margin-right: 30px">
                    ...
                    <li style="margin-bottom: 10px">
                        ...
                        <p style="display: inline">: {{$user->date_of_birth}}</p>
                    </li>
                </div>
                <div style="margin: 5px;font-family: Times New Roman ;">
                    ...
                    <button style="margin:15px 0px 0px 75px" type="button" class="btn btn-outline-secondary"><i class="fas fa-edit"></i> Thay đổi thông tin</button>
                </div>
            </div>
        </div>
        <div class="space"></div>
        <div class="col-md-12 text-center">
            <button style="width: 40%;margin-top: 20px;" type="button" class="btn btn-outline-secondary">
                <i class="fas fa-plus-square"></i> Lập kế hoạch
            </button>
        </div>
        ...
        @if($plan==null)
            <h4 class="form-control text-center alert-danger" style="margin-top: 30px">Bạn chưa tham gia kế hoạch nào!!!</h4>
        @else
