...
<html lang="en">
	<head>
		...
		<script>
			...
			var roads= {!! json_encode($markers) !!};
			var thisPostUrl='/plan/edit/'+plan.id;
		</script>
	</head>
	<body style="background-color: #f6f7f9;">
		...
		<div class="container" id="wrapper" style="margin-top:49px;" >
			<div class="box-shadow">
				<div style="margin: 18px 20px 25px; color:#260C96" ><h2>Sửa kế hoạch id {{$plan->id}}</h2></div>
				...
				<div class="row">
					...
					<div class="col-lg-8">
						<div class="form-row">
							...
							<div class="col-sm-10">
								<input type="text"  class="form-control" id="plan-name" autocomplete="off" value="{{$plan->name}}">
						...
						<div class="row">
							<div class="col-lg-6 form-group">
								...
								<input type="text" class="form-control" name="" id="start-time-input" value="{{Carbon::parse($plan->start_time)->format('d-m-Y H:i')}}">
								<span class="invalid-feedback" role="alert" style="display: block">
							...
							<div class="col-lg-6 form-group">
								...
								<input type="text" class="form-control" name="" id='end-time-input' value="{{Carbon::parse($plan->end_time)->format('d-m-Y H:i')}}">
								<span class="invalid-feedback" role="alert" style="display: block">
						...
						<div class="form-row" style="margin-top:15px">
							...
							<div class="col-sm-10">
								<select class="form-control" name="team_home" id="state">
									<option value="0">Lên kế hoạch</option>
			...
			<div class="box-shadow" style="padding: 5px 13px 5px">
				...
				<ul class="two-button-center" >
					<li style="display: inline;">
						<button class="btn btn-success" type="button" id='btn-submit'>Lưu thay đổi</button>
					</li>
					<li style="display: inline;">
						<button class="btn btn-secondary" type="button" id='btn-clear-all'>Xoá tất cả</button>
					</li>
					<li style="display: inline;">
						<a href="{{ URL::previous() }}"><button class="btn btn-primary" type="button" >Trở về</button></a>
					</li>
				</ul>
